...
package com.ai.classifai.tflite;
...
public abstract class Classifier {
  ...
  public static Classifier create(Activity activity)
    throws IOException {
      return create(activity, Device.CPU, -1);
  }
  ...
  public Recognition recognizeImageStrict(final Bitmap bitmap, int sensorOrientation)
  {
    return recognizeImageStrict(bitmap, sensorOrientation, .75);
  }
  public Recognition recognizeImageStrict(final Bitmap bitmap, int sensorOrientation, double threshold){
    List<Recognition> results = recognizeImage(bitmap, sensorOrientation);
    if(results.size() > 0){
